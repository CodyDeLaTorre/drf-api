...
class WizardTests(APITestCase):
    ...
    def setUpTestData(cls):
        ...
        test_wizard = Wizard.objects.create(
            ...
            source = 'Harry Potter',
            weapon = 'wand',
            description="loser whiny blonde boy",
        )
        test_wizard.save()
    ...
    def test_wizards_model(self):
        ...
        actual_description = str(wizard.description)
        actual_source = str(wizard.source)
        actual_weapon = str(wizard.weapon)
        ...
        self.assertEqual(actual_weapon, "wand")
        self.assertEqual(
            actual_description, "loser whiny blonde boy"
        )
    ...
    def test_create_wizard(self):
        url = reverse("wizard_list")
        data = {"creator": 1, "name": "Big Hat Logan", "description": "sells spells", "weapon": "wand", "source": "Dark Souls"}
    ...
    def test_update_wizard(self):
        ...
        data = {
            "creator": 1,
            "name": "Draco Malfoy",
            "description": "kinda became alright towards the end i guess.",
            "weapon": "wand",
            "source": "Harry Potter"
        }
        ...
        self.assertEqual(wizard.description, data["description"])
